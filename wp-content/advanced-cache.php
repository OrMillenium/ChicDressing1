...
$possible_plugin_locations = array(
	...
	'C:\wamp64\www\ChicDressing1\wp-content\plugins\wp-optimize\cache',
);
...
if (false === $plugin_location) {
	...
	if (strcasecmp('http://localhost/chicdressing1/', $protocol . '://' . $host . $request_uri) === 0) {
...
if (false !== $plugin_location) {
	...
	if (!defined('WPO_CACHE_EXT_DIR')) define('WPO_CACHE_EXT_DIR', 'C:\wamp64\www\ChicDressing1\wp-content\plugins\wp-optimize\cache/extensions');
}
